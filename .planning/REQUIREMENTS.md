...
- [ ] **CORE-02**: Service authenticates with Spotify via OAuth (one-time browser setup, then headless token refresh)
- [ ] **CORE-03**: Service runs as a macOS LaunchAgent and auto-restarts on crash
