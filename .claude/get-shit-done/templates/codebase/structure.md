...
- Usage: Reference from command with `@/home/cgallarno/Development/spotify-sentiment/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/cgallarno/Development/spotify-sentiment/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/cgallarno/Development/spotify-sentiment/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
