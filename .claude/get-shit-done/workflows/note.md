...
- **Global scope**: `/home/cgallarno/Development/spotify-sentiment/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/cgallarno/Development/spotify-sentiment/.claude/notes/`)
...
2. Glob `/home/cgallarno/Development/spotify-sentiment/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/cgallarno/Development/spotify-sentiment/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/cgallarno/Development/spotify-sentiment/.claude/notes/` — works in any directory
