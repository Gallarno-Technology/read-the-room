...
<required_reading>
@/home/cgallarno/Development/spotify-sentiment/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/cgallarno/Development/spotify-sentiment/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
