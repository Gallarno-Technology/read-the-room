...
Reference full template: `/home/cgallarno/Development/spotify-sentiment/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/cgallarno/Development/spotify-sentiment/.claude/get-shit-done/templates/state.md`.
